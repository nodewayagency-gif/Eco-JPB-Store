          ...
          <div className="flex items-center justify-between h-20">
            <Link href="/" className="flex items-center gap-2 group">
              <div className="relative">
                ...
                <img src={(logo as any).src || logo} alt="JPB Store" className="relative h-10 w-10 object-contain transition-transform duration-500 group-hover:scale-110" />
              </div>
            ...
            <div className="flex items-center gap-1.5 sm:gap-2">
              ...
              {isCustomerAuthenticated && userName ? (
                ...
                <Link href="/login" className="hidden md:flex p-2 rounded-lg hover:bg-secondary transition-colors duration-200" aria-label="Entrar">
